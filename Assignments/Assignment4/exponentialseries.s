...
__main  function
        ...
        MOV R2,#4;'n' Number of terms in series
        ...
        CMP R2,#1;comparing if series size is equal to 1
		IT EQ;
		BEQ stop;if series size equals one then jump to stop
...
STEP      VMUL.F32 S4,S4,S3; S4 = S4*S3 Multiply the intermedite term with Value Of X
		...
		CMP R3,R2;Compare 'm' and 'n'  
        BLT STEP;if m < n goto STEP 
